...
export interface IMemberInfoListScreenStyles {
  bodyViewStyle: ViewStyle;
  containerView: ViewStyle;
  childContainerView: ViewStyle;
  childContainerViewHeaderText: ViewStyle;
  rowContainerView: TextStyle;
...
export const memberListInfoScreenStyles: IMemberInfoListScreenStyles = {
  bodyViewStyle,
  containerView,
  childContainerView,
