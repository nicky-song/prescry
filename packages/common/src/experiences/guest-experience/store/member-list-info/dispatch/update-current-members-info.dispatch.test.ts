...
import { updateCurrentMembersInfoDispatch } from './update-current-members-info.dispatch';
import {
  IDependentProfile,
  ILimitedAccount,
  IPrimaryProfile,
...
describe('updateCurrentMembersInfoDispatch', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });

  it('dispatches member info update of primary member', () => {
    const secondaryAlertCarbonCopyIdentifier = 'mock-id-sie-adult';
    ...
    const state: RootState = {
      editMemberProfile: {
        secondaryUser: {
          identifier: secondaryAlertCarbonCopyIdentifier,
        },
    ...
    updateCurrentMembersInfoDispatch(dispatch, getState);
    ...
    const updatedProfileList = [
      ...
      },
      {
        ...
        primary: {
          ...
          age: 24,
          dateOfBirth: '01/01/2000',
          secondaryAlertCarbonCopyIdentifier: 'mock-id-sie-adult',
        } as IPrimaryProfile,
        childMembers: [
          {
            email: '',
