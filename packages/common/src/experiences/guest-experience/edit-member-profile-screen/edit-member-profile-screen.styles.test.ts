...
import {
  ...
  IEditMemberProfileScreenStyle,
} from './edit-member-profile-screen.styles';

describe('editMemberProfileScreenStyle', () => {
  it('has expected default styles', () => {
    ...
    const expectedStyles: IEditMemberProfileScreenStyle = {
      bodyInputText,
      bodyMobileInfoText,
      bodyPinText,
      bodyPlaceholderText,
    ...
    expect(editMemberProfileScreenStyle).toEqual(expectedStyles);
  });
});
