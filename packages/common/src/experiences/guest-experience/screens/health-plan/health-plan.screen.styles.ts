...
export interface IHealthPlanScreenStyles {
  headingTextStyle: TextStyle;
  rxCardCarouselViewStyle: ViewStyle;
  viewPlanAccumulatorsSectionViewStyle: ViewStyle;
  viewPlanAccumulatorsTextStyle: TextStyle;
  lineSeparatorOneViewStyle: ViewStyle;
  lineSeparatorTwoViewStyle: ViewStyle;
  lineSeparatorThreeViewStyle: ViewStyle;
  prescribersSectionViewStyle: ViewStyle;
  pharmaciesSectionViewStyle: ViewStyle;
  customerSupportViewStyle: ViewStyle;
  sectionViewStyle: ViewStyle;
}

export const healthPlanScreenStyles: IHealthPlanScreenStyles = {
  headingTextStyle: {
