...
import {
  IVerifyIdentityScreenStyles,
  verifyIdentityScreenStyles,
} from './verify-identity.screen.styles';

describe('verifyIdentityScreenStyles', () => {
  it('has expected styles', () => {
    ...
    const expectedStyles: IVerifyIdentityScreenStyles = {
    ...
    expect(verifyIdentityScreenStyles).toEqual(expectedStyles);
  });
});
