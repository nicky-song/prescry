...
export interface IUnauthHomeScreenStyles {
  containerViewStyle: ViewStyle;
  scrollViewStyle: ViewStyle;
  scrollContainerViewStyle: ViewStyle;
  drugSearchCardViewStyle?: ViewStyle;
  sectionTitleTextStyle?: TextStyle;
  sectionContentTextStyle?: TextStyle;
  prescriptionBenefitsViewStyle?: ViewStyle;
  prescriptionBenefitsButtonViewStyle?: ViewStyle;
  unauthLowerSectionViewStyle?: ViewStyle;
  backgroundIconImageStyle?: ImageStyle;
  marketingCardSectionViewStyle?: ViewStyle;
  firstMarketingCardRowViewStyle?: ViewStyle;
  lastMarketingCardRowViewStyle?: ViewStyle;
  firstMarketingCardViewStyle?: ViewStyle;
  lastMarketingCardViewStyle?: ViewStyle;
  bodyViewStyle?: ViewStyle;
  healthcareTechnologyViewStyle?: ViewStyle;
  servicesContainerViewStyle?: ViewStyle;
}
...
export const unauthHomeScreenDesktopStyles: IUnauthHomeScreenStyles = {
  containerViewStyle: {
...
export const unauthHomeScreenStyles: IUnauthHomeScreenStyles = {
  containerViewStyle: {
    paddingTop: Spacing.times2,
...
export const getUnauthHomeScreenStyles = (
  isDesktop: boolean
): IUnauthHomeScreenStyles => {
  return isDesktop ? unauthHomeScreenDesktopStyles : unauthHomeScreenStyles;
};
