...
import {
  createAppointmentFormStyles,
  ICreateAppointmentFormStyles,
} from './create-appointment-form.styles';

describe('CreateAppointmentFormStyles', () => {
  it('has expected styles', () => {
    ...
    const expectedStyles: ICreateAppointmentFormStyles = {
      aboutYouContainerViewStyle,
    ...
    expect(createAppointmentFormStyles).toEqual(expectedStyles);
  });
});
