...
export interface IFatalErrorStyles {
  fatalErrorViewStyle: ViewStyle;
  fatalErrorImageStyle: ImageStyle;
  fatalErrorTextStyle: TextStyle;
  subTitleTextStyle: TextStyle; 
  customErrorTextStyle: IMarkdownTextStyles;
  linkTextStyle: TextStyle;
}

export const FatalErrorStyles: IFatalErrorStyles = {
  fatalErrorViewStyle,
