...
export interface IOfferedServiceStyles {
  buttonViewStyle: ViewStyle;
  serviceTextTextStyle: TextStyle;
  dropDownArrowImage: ImageStyle;
  chevronDownBlueImage: ImageStyle;
  flexViewStyle: ViewStyle;
  hiddenContainerStyle: ViewStyle;
  iconImageStyle: ImageStyle;
  labelContainerViewStyle: ViewStyle;
  responsiveContainerViewStyle: ViewStyle;
  visibleContainerStyle: ViewStyle;
  serviceDescriptionViewStyle: ViewStyle;
  serviceDescriptionDesktopViewStyle: ViewStyle;
  serviceContentViewStyle: ViewStyle;
  serviceIconViewStyle: ViewStyle;
  serviceTitleTextStyle: TextStyle;
}
...
export const offeredServiceStyle: IOfferedServiceStyles = {
  buttonViewStyle,
...
export const offeredServiceDesktopStyles: IOfferedServiceStyles = {
  ...offeredServiceStyle,
