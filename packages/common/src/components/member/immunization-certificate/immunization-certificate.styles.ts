...
export interface IImmunizationCertificateStyles {
  certificateContainerViewStyle: ViewStyle;
  certificateDetailsContainerViewStyle: ViewStyle;
  certificateTitleViewStyle: ViewStyle;
  certificateTitleTextStyle: TextStyle;
  recordItemViewStyle: ViewStyle;
  recordItemHeaderTextStyle: TextStyle;
  recordItemValueTextStyle: TextStyle;
  recordDetailsViewStyle: ViewStyle;
  recordDetailsContainerViewStyle: ViewStyle;
}
...
export const immunizationCertificateStyles: IImmunizationCertificateStyles = {
