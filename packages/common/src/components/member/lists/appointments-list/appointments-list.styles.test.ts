...
import {
  appointmentsListStyles,
  IAppointmentsListStyles,
} from './appointments-list.styles';

describe('appointmentsListStyle', () => {
  it('has expected styles', () => {
    ...
    const expectedStyles: IAppointmentsListStyles = {
    ...
    expect(appointmentsListStyles).toEqual(expectedStyles);
  });
});
