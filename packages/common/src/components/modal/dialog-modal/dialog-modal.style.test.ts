...
import { IDialogModalStyles, dialogModalStyles } from './dialog-modal.style';

describe('dialogModalStyles', () => {
  it('has expected default styles', () => {
    const expectedStyles: IDialogModalStyles = {
    ...
    expect(dialogModalStyles).toEqual(expectedStyles);
  });
});
