...
import {
  IRecoveryEmailModalStyles,
  recoveryEmailModalStyles,
} from './recovery-email-modal.styles';

describe('recoveryEmailModalStyles', () => {
  it('has expected default styles', () => {
    ...
    const expectedStyles: IRecoveryEmailModalStyles = {
    ...
    expect(recoveryEmailModalStyles).toEqual(expectedStyles);
  });
});
