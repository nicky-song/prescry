...
import { FavoritingErrorNotification } from './favoriting-error.notification';
...
describe('FavoritingErrorNotification', () => {
  beforeEach(() => {
    jest.clearAllMocks();

    useContentMock.mockReturnValue({
      isContentLoading: false,
      content: { favoritingPharmacyError: 'favoriting-pharmacy-error-mock' },
    });
  });
  ...
  it('renders BaseNotification as expected by default', () => {
    ...
    expect(baseNotification.props.message).toEqual(
      'favoriting-pharmacy-error-mock'
    );
