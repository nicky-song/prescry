...
import {
  IBaseNotificationStyles,
  baseNotificationStyles,
} from './base.notification.styles';

describe('baseNotificationStyles', () => {
  it('has expected styles', () => {
    const expectedStyles: IBaseNotificationStyles = {
      iconTextStyle: {
    ...
    expect(baseNotificationStyles).toEqual(expectedStyles);
  });
});
