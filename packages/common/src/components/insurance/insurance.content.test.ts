...
import { IInsuranceContent, insuranceContent } from './insurance.content';

describe('insuranceContent', () => {
  it('has expected content', () => {
    const expectedContent: IInsuranceContent = {
      headingTitle:
    ...
    expect(insuranceContent).toEqual(expectedContent);
  });
});
