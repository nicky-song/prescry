...
import { appointmentCalendarStyle } from './appointment-calendar.style';
import { FontWeight, getFontFace } from '../../fonts';
import { Spacing } from '../../spacing';
import { GrayScaleColor } from '../../colors';

describe('appointmentCalendarStyle', () => {
  it('has expected styles', () => {
    ...
    expect(appointmentCalendarStyle).toEqual(expectedStyles);
  });
});
