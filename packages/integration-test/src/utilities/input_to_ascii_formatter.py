...
default_diacritics_removal_map = [
  ...
  {"base": "a", "letters": "[\u24D0\uFF41\u1E9A\u00E0\u00E1\u00E2\u1EA7\u1EA5\u1EAB\u1EA9\u00E3\u0101\u0103\u1EB1\u1EAF\u1EB5\u1EB3\u0227\u01E1\u00E4\u01DF\u1EA3\u00E5\u01FB\u01CE\u0201\u0203\u1EA1\u1EAD\u1EB7\u1E01\u0105\u2C65\u0250]+"},
  {"base": "aa","letters": "[\uA733]+"},
  {"base": "ae","letters": "[\u00E6\u01FD\u01E3]+"},
  {"base": "ao","letters": "[\uA735]+"},
  {"base": "au","letters": "[\uA737]+"},
  ...
  {"base": "lj","letters": "[\u01C9]+"},
  {"base": "m", "letters": "[\u24DC\uFF4D\u1E3F\u1E41\u1E43\u0271\u026F]+"},
  {"base": "n", "letters": "[\u24DD\uFF4E\u01F9\u0144\u00F1\u1E45\u0148\u1E47\u0146\u1E4B\u1E49\u019E\u0272\u0149\uA791\uA7A5]+"},
  {"base": "nj","letters": "[\u01CC]+"},
  {"base": "o", "letters": "[\u24DE\uFF4F\u00F2\u00F3\u00F4\u1ED3\u1ED1\u1ED7\u1ED5\u00F5\u1E4D\u022D\u1E4F\u014D\u1E51\u1E53\u014F\u022F\u0231\u00F6\u022B\u1ECF\u0151\u01D2\u020D\u020F\u01A1\u1EDD\u1EDB\u1EE1\u1EDF\u1EE3\u1ECD\u1ED9\u01EB\u01ED\u00F8\u01FF\u0254\uA74B\uA74D\u0275]+"},
  {"base": "oi","letters": "[\u01A3]+"},
  {"base": "ou","letters": "[\u0223]+"},
  {"base": "oo","letters": "[\uA74F]+"},
  {"base": "p","letters": "[\u24DF\uFF50\u1E55\u1E57\u01A5\u1D7D\uA751\uA753\uA755]+"},
...
def remove_diacritics(input):
  clean = input
  for d in default_diacritics_removal_map:
    clean = re.sub(u"{}".format(d["letters"]), d["base"], clean)
  return clean

def remove_non_letters(input):
  return re.sub(r'[^a-zA-Z\-]+', '', input)

def input_to_ASCII_formatter(input, only_letters):
  removed_diacritics_input = remove_diacritics(input)

  if (only_letters):
    return remove_non_letters(removed_diacritics_input)
  else:
    return removed_diacritics_input