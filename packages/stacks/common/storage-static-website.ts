...
class StorageStaticWebsiteProvider implements pulumi.dynamic.ResourceProvider {
  public async check(
    ...
    if (news[accountNameProp] === undefined) {
      failures.push({
        property: accountNameProp,
        reason: `required property '${accountNameProp}' missing`,
      });
    }
...
export class StorageStaticWebsite extends pulumi.dynamic.Resource {
  public readonly endpoint: pulumi.Output<string> = output('');
  public readonly hostName: pulumi.Output<string> = output('');
  public readonly webContainerName: pulumi.Output<string> = output('');
