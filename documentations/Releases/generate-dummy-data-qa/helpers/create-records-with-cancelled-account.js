...
export const createRecordsWithCancelledAccount = async (
  totalRecords,
  batchSize,
  sleepInterval,
  dbConnection,
  ...
  await writeToLogAndConsole(
    progressLogger,
    'Starting createRecordsWithCancelledAccount '
  );
  ...
  await writeToLogAndConsole(
    progressLogger,
    'Ending createRecordsWithCancelledAccount '
  );
  return phoneNum;
};
