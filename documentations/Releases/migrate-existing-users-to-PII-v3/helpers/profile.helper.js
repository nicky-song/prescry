...
export const hydrateProfilesFromCashUsers = async (cashUsers, logScope) => {
  ...
  return hydrateAllProfiles(cashUsers, pbmUsers, phoneNumbers, false, logScope);
};
...
export const hydrateProfilesFromPbmUsers = async (pbmUsers, logScope) => {
  ...
  return hydrateAllProfiles(cashUsers, pbmUsers, phoneNumbers, true, logScope);
};
...
export const hydrateAllProfiles = async (
  ...
  const accounts = await getAccountsForPhoneNumbers(phoneNumbers);
